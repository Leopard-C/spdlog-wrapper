...
public:
    ...
    std::vector<DailyFileConfig> daily_file_configs() const { return daily_file_configs_; }
    std::vector<RotatingFileConfig> rotating_file_configs() const { return rotating_file_configs_; }
